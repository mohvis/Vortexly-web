...
export const DEFAULT_STATE: EditorState = {
  ...
  twoLabels: {
    topEye:   { text: 'The Original',                      color: '#b0a898', fontSize: 11 },
    topBrand: { text: 'Patek\nPhilippe',                   color: '#1a1814', fontSize: 50 },
    topModel: { text: 'Nautilus 5811',                     color: '#7a7060', fontSize: 17 },
    topPrice: { text: '₹1,20,00,000+',                    color: '#5a5248', fontSize: 15 },
    botEye:   { text: 'Same Vibe · Fraction of the Price', color: '#b0a898', fontSize: 11 },
    botBrand: { text: 'Your\nBrand',                       color: '#1a1814', fontSize: 42 },
    botModel: { text: 'Nautilus 5811',                     color: '#7a7060', fontSize: 17 },
    botPrice: { text: '₹399 only',                        color: '#2a6640', fontSize: 42 },
    botTag:   { text: 'Affordable · Looks just as good',   color: '#aaa098', fontSize: 11 },
  },
  oneLabels: {
    eye:   { text: 'Your Brand',  color: '#a09890', fontSize: 11 },
    brand: { text: 'Brand Name',  color: '#1a1814', fontSize: 72 },
    model: { text: 'Model Name',  color: '#7a7060', fontSize: 22 },
    price: { text: '₹00,000',     color: '#5a5248', fontSize: 20 },
  },
  singleAlign:     'left',
